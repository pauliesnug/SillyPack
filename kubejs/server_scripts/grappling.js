ServerEvents.recipes(event => {
	...
	event.shapeless(
		...
		let nbt = inventory.find(Item.of("minecraft:chainmail_boots")).copy().nbt
		let newEnchantments = nbt.Enchantments.filter(enchant => enchant.id !== "minecraft:feather_falling")
